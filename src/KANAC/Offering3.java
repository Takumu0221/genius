...
public class Offering3 extends OfferingStrategy {
    ...
    public BidDetails determineNextBid() {
        ...
        target = max - (max - finalTarget) * Math.pow(negotiationSession.getTime(), 0.25);
