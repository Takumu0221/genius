...
public class shimizu_agent extends BoaParty
{
	@Override
	public void init(NegotiationInfo info) 
	{
		// The choice for each component is made here
		AcceptanceStrategy 	ac  = new shimizu_AS();
		OfferingStrategy 	os  = new shimizu_OS();
		OpponentModel 		om  = new shimizu_OM();
		OMStrategy			oms = new shimizu_OMS();
